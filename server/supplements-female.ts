    ...
    evaluate: (labs) => {
      ...
      if (labs.vitaminD > 20 && labs.vitaminD <= 40) {
        return {
          ...
          rationale: "D3 5,000 + K provides vitamin D3 with K2 for repletion. Supports bone health and cardiovascular function. Target ≥60 ng/mL."
        };
      }
    ...
    evaluate: (labs) => {
      ...
      if (labs.vitaminD > 40 && labs.vitaminD < 60) {
        return {
          ...
          rationale: "D3 2000 Complex provides maintenance vitamin D with cofactors to reach optimal range ≥60 ng/mL for bone and immune support."
        };
      }
