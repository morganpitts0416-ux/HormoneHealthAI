        ...
        <div className="w-full max-w-sm">
          ...
          {status === "validating" && (
            <div className="flex flex-col items-center gap-4 py-12">
              ...
              <p className="text-sm" style={{ color: "#7a8a64" }}>Verifying your invite link…</p>
            </div>
          )}
          ...
          {status === "invalid" && (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm leading-relaxed" style={{ color: "#7a8a64" }}>
                This invite link is no longer valid. It may have expired (invite links last 72 hours) or already been used.
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-sm mt-1" style={{ color: "#7a8a64" }}>
                  Set your password to activate your ReAlign Health account
                  {email ? ` for ${email}` : ""}.
                </p>
              </div>
          ...
          {status === "success" && (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm leading-relaxed" style={{ color: "#7a8a64" }}>
                Your account is now active. Sign in with your username and new password to get started.
              </p>
              <Button
                className="w-full"
                onClick={() => setLocation("/login")}
