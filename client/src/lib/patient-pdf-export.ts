...
export async function generatePatientWellnessPDF(
  ...
  /** Hormone-pattern row categories hidden from the patient. */
  ...
  // compositing (transparent PNGs blend into the header background color).
  const FEMALE_DEFAULT = { primaryColor: "#1f4e79", accentColor: "#3b82f6", formBackgroundColor: "#f8fafc" };
