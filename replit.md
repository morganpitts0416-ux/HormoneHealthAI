...
-   **PREVENT Cardiovascular Risk Assessment (2023 AHA)**: For the women's clinic, calculates cardiovascular risk using the 2023 AHA PREVENT equations - a race-free model that predicts 10-year and 30-year risks for Total CVD, ASCVD, and Heart Failure. Requires age, sex, systolic BP, total cholesterol, HDL, eGFR, BMI, diabetes, smoking, BP medication, and statin use. The 30-year predictions are only valid for ages 30-59. Located in `server/prevent-calculator.ts`.
